<template>
	<view>
		<view class="head">
			...
			<view class="headContent">设置</view>
		</view>
		<view class="userInfoSetting">
			<view class="userEssInfo">
				<view @click="selectImg" class="userImg">
					<img src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/headImgjpg.jpg" alt="">
				</view>
				...
				<view @click="setUsernameEamil=!setUsernameEamil">
					<img src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/edit.png" alt="">
				</view>
			</view>
			<view class="userAccount">
				<view class="userAccountItem" @click="open(index)" v-for="(userAccountItem,index) in user" :key="index">
					...
					<view class="userAccountSet" @click="changeUserAccount(userAccountItem)">
						<img v-if="!userAccountItem.active" style="width: 50rpx;" src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/rightarrow.png"
							alt="">
						<img v-else style="width: 50rpx;" src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/downarrow.png" alt="">
					</view>
				</view>
			</view>
				...
				<view class="userAllInfoItem" v-for="(userAllInfoItem,key,index) in userset" :key="index">
					...
					<view style="display: flex;align-items: center;width: 300rpx;justify-content: flex-end;">
						...
						<view class="userAllInfoSet" v-if="SetContent[key].isSet"
							...
							<img v-if="!SetContent[key].active" style="width: 50rpx;" src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/rightarrow.png"
								alt="">
							<img v-else style="width: 50rpx;" src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/downarrow.png" alt="">
						</view>
					</view>
	...
	export default {
		data() {
			return {
				...
				user: [{
						userAccountImg: 'https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/Password.png',
						userAccountContent: ["密码", "更改密码"],
						active: false
					},
					{
						userAccountImg: 'https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/Email.png',
						userAccountContent: ["邮箱", "更改邮箱"],
						active: false
					},
					{
						userAccountImg: 'https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/Language.png',
						userAccountContent: ["语言", "更改语言"],
						active: false
					},
					{
						userAccountImg: 'https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/user/Privacy.png',
						userAccountContent: ["安全", "安全设置"],
						active: false
					}
				],
			// 	userset: [{
