	...
	<view>
		...
		<view class="navBarBox">
			...
			<view class="navBar">
				...
				<view class="nav-pic">
					<u-image class="img" src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/icon/heartWhite.png" width="16" height="16"></u-image>
				</view>
				<view class="text">
		...
		<view class="pic">
			<view class="text">
				<view class="title">
					AVG_strokes_possible
				</view>
				<view class="context">
					<view class="data">{{avgGlucoseLevelAverage.length==0 ? "0":avgGlucoseLevelAverage}}mmol/L</view>
					<view class="percent">
						<img src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/icon/up.png" alt="">
						0.1(5.58%)
					</view>
				</view>
			</view>
		...
		<view class="glucose">
			...
			<view class="card center" style="background: linear-gradient(90.00deg, rgba(249, 245, 242, 1.00) -1.79%, rgba(218, 213, 255, 1.00) 100%);">
				<view class="glucoseImg">
					<image mode="aspectFill" src="https://cdn.jsdelivr.net/gh/motonik/Photo-Repositary@main/glucose.jpg" alt="">
				</view>
				<view class="title">
					<view>
